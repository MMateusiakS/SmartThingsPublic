...
metadata {
	definition (name: "EatonBasicSwitch", namespace: "MMateusiakS", author: "Malgorzata Mateusiak") {
		capability "Switch"
        
        fingerprint inClusters: "0x25,0x70"
        fingerprint mfr:"001A", prod:"534C", model:"0000"
        fingerprint mfr:"001A", prod:"5352", model:"0000"
	...
	tiles {
    	...
    	standardTile("switchEaton", "device.switch", width: 3, height: 3, canChangeIcon: true) {
                        state "on", label: '${Name}', action: "switch.off",
                              icon: "st.Lighting.light11", backgroundColor: "#f1d801"
